...
//			(byte) 0x00, (byte) 0x00 };
	...
	public MessageBlockGameEndInfo(RoomInfo room, int qId) {
		...
		for (int i = 0; i < room.getNumPlayersOnSel(); i++) {
			...
			PlayerInfo p = room.getPlayerFromPid(pid);
			if( p == null ) {
				System.out.println( "ATENCIÓN!");
				System.out.println( "No existe jugador en sel: " + i + ", su pid debería ser: " + pid );
				continue;
			}
...
//		}
		 ...
		 * 
		 * De momento lo dejamos a cero porque no nos queremos meter en el follón de los
		 * grupos aún.
		 */
