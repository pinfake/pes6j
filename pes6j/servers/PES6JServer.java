...
public class PES6JServer {
	...
	void processMessageBlock(PESConnection out, MetaMessageBlock mb)
		 ...
		 */) {
			...
			serverList.add( new ServerInfo(7, "GROUP-SP/", Configuration.serverProperties
							.getProperty("server-ip"), 10887, 0));
			serverList.add( new ServerInfo(6, "SCHE-SP/", Configuration.serverProperties
							.getProperty("server-ip"), 10887, 0));
			serverList.add( new ServerInfo(4, "QUICK0-SP/", Configuration.serverProperties
							.getProperty("server-ip"), 10887, 0));
			serverList.add( new ServerInfo(4, "QUICK1-SP/", Configuration.serverProperties
							.getProperty("server-ip"), 10887, 0));
			serverList.add( new ServerInfo(8, "MENU03-SP/", Configuration.serverProperties
							.getProperty("server-ip"), 12881, 0));
			int i = 0;
			String serverName;
...
//					System.out.println("no conn, numplayers es: " + numPlayers);
				...
				serverList.add( new ServerInfo(3, serverName, serverIp, serverPort, numPlayers));
				i++;
			}
			
			serverList.add( new ServerInfo(2, "ACCT03-SP/", Configuration.serverProperties
							.getProperty("server-ip"), 12881, 0));
			serverList.add( new ServerInfo(1, "GATE-SP/", Configuration.serverProperties
							.getProperty("server-ip"), 10887, 0));
